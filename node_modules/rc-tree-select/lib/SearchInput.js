...
function (_React$Component) {
  ...
  function SearchInput() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "alignInputWidth", function () {
      _this.inputRef.current.style.width = "".concat(_this.mirrorInputRef.current.clientWidth, "px");
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "focus", function (isDidMount) {
