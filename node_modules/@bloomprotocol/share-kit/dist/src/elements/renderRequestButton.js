...
/* tslint:enable:max-line-length */
/* tslint:disable:max-line-length */
var renderBloomLogo = function (id) {
    var svg = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
    svg.id = id + "-logo";
    svg.setAttribute('viewBox', '0 0 710 705');
    svg.setAttribute('width', '22px');
    svg.setAttribute('height', '22px');
    var renderLeafPath = function () {
        var leaf = document.createElementNS('http://www.w3.org/2000/svg', 'path');
        leaf.setAttribute('d', 'M194.415739,215.192523 C194.258317,268.684765 150.797287,312 97.2080838,312 C43.6188804,312 0.157850908,268.684765 0.000429008653,215.192523 C2.08721929e-14,215.192523 -3.50299401,197.114019 15.1796407,156.874766 C47.118659,88.0834938 95.9422811,58.317757 95.9422811,58.317757 C95.9422811,58.317757 148.877246,91.5588785 180.404192,156.874766 C196.94399,191.141061 194.416168,215.192523 194.416168,215.192523 Z');
        return leaf;
    };
    var firstLeaf = document.createElementNS('http://www.w3.org/2000/svg', 'g');
    firstLeaf.setAttribute('transform', 'translate(260.000000, -27.000000)');
    firstLeaf.appendChild(renderLeafPath());
    var secondLeaf = document.createElementNS('http://www.w3.org/2000/svg', 'g');
    secondLeaf.setAttribute('transform', 'translate(357.500000, 576.000000) scale(1, -1) translate(-357.500000, -576.000000) translate(260.000000, 420.000000)');
    secondLeaf.appendChild(renderLeafPath());
    var thirdLeaf = document.createElementNS('http://www.w3.org/2000/svg', 'g');
    thirdLeaf.setAttribute('transform', 'translate(563.000000, 352.500000) scale(1, -1) rotate(90.000000) translate(-563.000000, -352.500000) translate(465.500000, 196.500000)');
    thirdLeaf.appendChild(renderLeafPath());
    var fourthLeaf = document.createElementNS('http://www.w3.org/2000/svg', 'g');
    fourthLeaf.setAttribute('transform', 'translate(147.000000, 351.500000) scale(-1, -1) rotate(90.000000) translate(-147.000000, -351.500000) translate(49.500000, 195.500000)');
...
exports.renderRequestButton = renderRequestButton;
var updateRequestButton = function (id, container) { return function (config) {
    var button = container.querySelector("#" + id);
    if (!button)
        return;
    button.href = getLink(config.requestData, config.buttonCallbackUrl);
}; };
var removeRequestButton = function (id, container) { return function () {
    var button = container.querySelector("#" + id);
    if (button)
        button.remove();
}; };
var templateObject_1;
//# sourceMappingURL=renderRequestButton.js.map