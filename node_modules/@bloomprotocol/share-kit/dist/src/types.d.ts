...
declare type OSDetails = Details & {
    versionName?: string;
};
declare type PlatformDetails = {
    type?: string;
    vendor?: string;
    model?: string;
};
declare type ShouldRenderButton = (parsedResult: ParsedResult) => boolean;
declare type RequestElementResult = {
    update: (config: {
...
export { Action, RequestData, ErrorCorrectionLevel, QROptions, ShouldRenderButton, RequestElementResult, IProof, IProofShare, IVerifiedData, ResponseData, };
