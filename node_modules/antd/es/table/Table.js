...
function (_React$Component) {
  ...
  _createClass(Table, [{
    ...
    value: function getCurrentPageData() {
      ...
      var pagination = this.props.pagination || {}; // 如果没有分页的话，默认全部展示
      ...
      if (data.length > pageSize || pageSize === Number.MAX_VALUE || pagination.current === undefined && current * pageSize > data.length) {
